					...
					<div class="col-xs-12 col-sm-0 col-md-0 col-lg-0 clearfix visible-xs" style="float:left;height:55px;background-color:#232323">
						...
						<div class="collapse navbar-collapse" id="example-navbar-collapse" style="float:left;width:100%;background-color:#232323">
							<ul class="nav navbar-nav">
								<li><a href="teacher_profile.php" id="n_view"><i class="fa fa-tachometer"></i>&nbsp;Home</a></li>
								<li><a href="teachers_Batches.php" id="n_view"><i class="fa fa-users"></i>&nbsp;Batches</a></li>
								<li><a href="teachers_students.php" id="n_view"><span class="glyphicon glyphicon-list"></span>&nbsp;Students</a></li>
								<li><a href="teacher_settings.php" id="n_view"><span class="glyphicon glyphicon-wrench"></span>&nbsp;Settings</a></li>
								<li><a href="teachers_logout.php" id="n_view"><span class="glyphicon glyphicon-off"></span>&nbsp;Turn off [<?php echo " " . $_SESSION['name'] . " "; ?>]</a></li>
