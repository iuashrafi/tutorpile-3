...
<html>
<head>
	<title>Tutor Pile | Contact us</title>
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="background-color:;">
		...
		if(isset($_POST["feedback"]) && $_SERVER["REQUEST_METHOD"]=="POST" )
		{
			...
			if($fname_err==$msg_err && $msg_err==$emailid_err && $emailid_err==$phno_err && $phno_err=="")
			{
				...
				$feedob->submit_contactus();
				header("location:contactus.php");
			}
		}
		?>
		<h2 class="title_of_page">Contact us</h2><hr/>
		<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST">
				...
				<div class="row">
					<div class="col-sm-12 col-lg-9 text-right">
						<input class="btn btn-action btn-smit" type="submit" name="feedback" value="Send message">
					</div>
				</div>
		</form>
	</div>
